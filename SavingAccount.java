 ...
 * Purpose: A sub-class of the super BankAccount class that contain all the saving account information and behaviours, also implements the interface InterestPayable to apply different use to calcInterest().
...
public class SavingAccount extends BankAccount implements InterestPayable {
	...
	//Declares and initializes a private CONSTANT static double type variables to hold the INTEREST RATE.
	...
	SavingAccount(String customerName, String month, double balance) {
		...
		//Sets the account type to a Saving account.
		this.setAccountTypes("Saving");
	...
	public void calcInterest() {
		...
		//Checks if the balance is greater or equals than 25 dollars.
		if(this.balance >= this.MINIMUM_ACCOUNT_BALANCE) {
			//Calculates the monthly interest amount.
			monthlyInterestAmount = (SavingAccount.INT_RATE / 12.0);
		}//End of single-selection if statement.

		//Declares and initializes a boolean type variable.
		boolean isHighBalance = false;

		//Declares and initializes a double CONSTANT type variable to get rid of magic numbers.
		final double MINIMUM_HIGH_BALANCE_BONUS = 2000.0;
		final double HIGH_BALANCE_INTEREST_BONUS = 0.0075;
		//Declares and initializes a double CONSTANT type variable to get rid of magic numbers.
		final int MONTHS = 12;
		...
		for(Transaction i : this.record) {
			...
			//Checks if the balance in each record is greater or equals than 2000 dollars.
			if(i.getBalance() >= MINIMUM_HIGH_BALANCE_BONUS) {

				//Assigns the boolean type variable to true.
				isHighBalance = true;
		...
		//Checks if the boolean type variable is true.
		if(isHighBalance == true) {
			//Applies the bonus.
			monthlyInterestAmount += HIGH_BALANCE_INTEREST_BONUS / MONTHS;
		}//End of if statement.

		//Updates the monthly interest amount.
		monthlyInterestAmount *= this.balance;
		//Updates the balance.
		this.balance += monthlyInterestAmount;
	...
	public String toString() {
		...
		//Returns the account number, number of withdrawals, number of deposits, the balance, if the account is active, and the annual interest rate.
		return "Account Number: \t  " + this.accountNumber + "\nNumber of Withdrawals: \t  " + this.numberWithdrawals + "\nNumber of Deposits: \t  "
				+ this.numberDeposits + "\nBalance: \t\t  " + this.balance + "\nAccount Active: \t  " + this.accountActive + "\nAnnual Interest Rate: \t  "
				+ SavingAccount.INT_RATE;

	}//End of toString() method.

}//End SavingAccount class.